...
from whisper.utils import optional_int, optional_float, str2bool, write_vtt
...
def cli():
    ...
    basic_group.add_argument("audio", nargs="+", type=str, help="Audio file(s) to transcribe")
    ...
    basic_group.add_argument("--output_dir", "-o", type=str, default=".", help="directory to save the outputs")
